...
const mockLoadSuccess = (): void => { cy.fixture('load-survey-result').then(surveyResult => { Http.mockOk(path, 'GET', surveyResult) }) }
...
describe('SurveyResult', () => {
  ...
  describe('save', () => {
    ...
    const mockSaveSuccess = (): void => { cy.fixture('save-survey-result').then(surveyResult => { Http.mockOk(path, 'PUT', surveyResult) }) }
